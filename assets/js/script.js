  ...
  theme: {
    extend: {
      colors: {
        ...
        background: "#FFF9D5",
        "on-background": "#1E1C2E",
        "secondary-container": "#38BDF8",
        surface: "#FFF9D5",
        "primary-container": "#FF9D50",
      },
      fontFamily: {
      ...
      boxShadow: {
        "brutal-sm": "3px 3px 0 0 #1E1C2E",
        brutal: "5px 5px 0 0 #1E1C2E",
        "brutal-lg": "7px 7px 0 0 #1E1C2E",
        "brutal-xl": "10px 10px 0 0 #1E1C2E",
      },
      borderRadius: {
        sm: "4px",
        DEFAULT: "4px",
